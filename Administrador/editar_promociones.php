...
$query = "SELECT * FROM promociones WHERE id = $id AND eliminado = 0";
$result = mysqli_query($con, $query);
$promocion = mysqli_fetch_assoc($result);
...
<form id="formEditar" method="POST" enctype="multipart/form-data" novalidate>
    ...
    <input type="text" id="nombre" name="nombre" placeholder="Nombre" value="<?php echo $promocion['nombre']; ?>" required><br>
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    if (respuesta === "success") {
                        ...
                        mensaje.text('Error al actualizar la promocion.');
                    }
                },
                error: function () {
